		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ASSD",
									"targetURL": "#rheinmetalassd-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"rheinmetalassd-display": {
								"semanticObject": "rheinmetalassd",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=rheinmetalassd",
									"url": sap.ui.require.toUrl("rheinmetalassd")
								}
							}
						}
					}
